          ...
          <div class="Questions">
            <table class="Questions_list">
              ...
              <c:forEach var="review" items="${reviewlist }">
                  ...
                  <td>
                    <input type="button" value="답글" onclick="location.href='${root}admin/review/answer?r_num=${review.r_num}'">
                    <input type="button" value="삭제" onclick="del_review('${review.r_num}')">
              		</td>
                </tr>
              </c:forEach>
