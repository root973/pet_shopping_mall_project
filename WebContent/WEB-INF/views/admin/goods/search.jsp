            ...
            <div class="goods">
                <div>
                    ...
                    <table>
						...
						<tbody>
							<tr>
								<td class="img1"><a href='${root }admin/goods/modify?goods_code=${goods.goods_code}&page=1'><img src="../../${goods.thumbnail_img_url}" height="100" width="100"></a></td>
								<td class="code1">${goods.goods_code}</td>
								<td class="name"><a href='${root }admin/goods/modify?goods_code=${goods.goods_code}&page=1'>${goods.goods_name}</a></td>
