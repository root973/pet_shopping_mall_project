	...
	<section>
		<div class="main">
			<div class="main_form">
				...
				<form action="${root }admin/goods/add_pro" method="post"
					enctype="multipart/form-data">
					<div>
						<label class="form-label"><b>대카테고리</b></label> <select
							name="category_big" id="secter" onchange="on(this)">
					...
					<div id="sub">
						<label class='form-label'><b>소카테고리</b></label> <select
							name='category_small'>
					...
					<div>
						...
						<span><input type="text" name="option_1"
							placeholder="*ex) 빨간색|노란색|파란색"></span>
					</div>
					...
					<div class="goods_info">
						...
						<textarea cols="30" rows="5" placeholder="제품 상세내용 적어주세요."
							name="info"></textarea>
